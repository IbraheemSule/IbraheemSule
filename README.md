...
|---|---|
| Business Intelligence | Power BI Desktop, Power BI Service, Paginated Reports, SSRS |
| Data Analysis | DAX, Power Query, SQL, T-SQL, Python, Excel |
| Data Platforms | SQL Server, Snowflake, Microsoft Fabric, Azure SQL |
| Cloud & Data Engineering | Azure Synapse, Azure Data Factory, ADLS, Databricks |
| Data Modeling | Star Schema, Snowflake Schema, Semantic Models, Tabular Models |
| Development & Collaboration | Git, GitHub, Azure DevOps, Agile, Scrum |
| Security & Governance | Row-Level Security, Data Governance, Workspace Management |
